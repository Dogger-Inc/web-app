...
const handleSubmitComment = () => {
    ...
    if (commentToEdit.value) {
        editCommentForm.patch(route('dashboard.issues.editComment.patch', props.issue?.id), {
    ...
    addCommentForm.post(route('dashboard.issues.addComment.post', props.issue?.id), {
